...
基于《Minecraft Explorer’s Handbook》图片与文字制作的中文第一人称 3D 探索游戏。当前 v0.5 包含林地营地、平原村庄往返、指南针、三种森林观察，以及三层林地府邸的探索、简化战斗和返程。下一节丛林与神庙仍待开发。
...
完成森林考察后，带石斧、熟食或面包，以及至少一块原木，沿营地南侧小路找到三层府邸。正门旁按 E 阅读入内须知。
...
按 3 装备石斧，近距离对准守卫按住左键攻击。卫道士抬斧时后退，唤魔者脚下红色预警出现后走开。F 食物恢复饥饿和 2 点生命；床可恢复满生命。Esc 暂停；生命耗尽回休息点，物资保留。已领取奖励、打开的门、击退的守卫和悦灵跟随状态随存档保留。
...
- 22 种物品、10 个制作配方、3 个村民交易、烹饪/烧炭、46 块小屋蓝图、工作台范围限制、4 个工具槽与自动显示的指南针。
- 新手目标、中文制作与背包、章节手记、安全首夜、关键动作和定时存档。
- 采集/建造/制作的简短音效。

## 当前范围

这是逐章开发版本。建造仍采用辅助蓝图，尚未实现自由地形挖掘、任意搭建、耐久、船、完整种植和地图合成/缩放。战斗目前限于府邸中的卫道士与唤魔者简化教学。熔炉支持牛肉烹饪与原木烧炭；未加入矿物冶炼。床支持休息点和生命恢复，暂不包含完整昼夜作息。石斧加快采木，木镐采石；第一夜仍为安全教学。
