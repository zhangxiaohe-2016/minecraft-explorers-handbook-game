...
基于《Minecraft Explorer’s Handbook》图片与文字制作的中文第一人称 3D 探索游戏。当前 v0.5.1 包含林地营地、平原村庄往返、指南针、三种森林观察、三层林地府邸探索与简化战斗，以及木剑、地图兴趣点旗标和朝东向日葵补漏。下一节丛林与神庙仍待开发。
...
这是逐章开发版本。建造仍采用辅助蓝图，尚未实现自由地形挖掘、任意搭建、耐久、船、完整种植和地图合成/缩放。战斗目前限于府邸中的卫道士与唤魔者简化教学；木剑为更短间隔的教学武器，无耐久。熔炉支持牛肉烹饪与原木烧炭；未加入矿物冶炼。床支持休息点和生命恢复，暂不包含完整昼夜作息。石斧加快采木，木镐采石；第一夜仍为安全教学。
