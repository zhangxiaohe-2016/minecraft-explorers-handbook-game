...
基于用户提供的《Minecraft Explorer’s Handbook》内容规划的中文第一人称 3D 探索游戏。**当前 v0.3 包含“林地营地”、平原村庄往返，以及村庄外的森林瞭望台地标：补给、床、烹饪、交易、地图、指南针和路线记录。温带区域的其他场景及后续大章尚未实现。**
...
8. 远行完成后，沿村庄西侧小路向南走到森林瞭望台，对准补给箱按 E 领取指南针，记录下一段温带路线。
