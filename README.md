...
基于《Minecraft Explorer’s Handbook》图片与文字制作的中文第一人称 3D 探索游戏。当前 v0.4 包含林地营地、平原村庄往返、指南针，以及繁花森林、白桦林和黑森林的观察返程路线。林地府邸及后续章节仍待开发。
...
书第 18 页规定指南针行为，第 28–29 页介绍三种森林。瞭望台、观察牌、赠送指南针及缩小的路线为教学设计；尚未实现磁石、染料、狼、敌对生物和林地府邸。详见 [森林开发与审核记录](docs/FOREST_REVIEW.md)。
...
- 21 种物品、10 个制作配方、3 个村民交易、烹饪/烧炭、46 块小屋蓝图、工作台范围限制、4 个工具槽与自动显示的指南针。
